                  ...
                  return FutureBuilder(
                      ...
                      builder: (context, snapshotS) {
                        if (snapshotS.hasData) {
                          ...
                          final cal_break = snapshotS.data!.cal_o.toString();
                                            ...
                                            return ElevatedButton(
                                              onPressed: () async {
                                                ...
                                                final foodCal = CalModelO(
                                                  cal_o: (double.parse(cal_break) + double.parse(ui)).toStringAsFixed(1),
                                                );
                                                ...
                                                await controllerFoodB.updateCalO(foodCal, id, id_b.toString());
                                          ...
                                          if(snapshotPFC.hasData){
                                            ...
                                            return ElevatedButton(
                                              onPressed: () {
                                                ...
                                                final foodRepo = Get.put(FoodRepository());
                                                foodRepo.createFoodRecordO(foodRecord, id.toString());
                                                foodRepo.createFoodCalO(foodCal, id.toString());
                                                foodRepo.updatePFC(foodPCF, id.toString(), id_PFC.toString());
                                                widget.goTR.goToRoute(AllRoutes.food);
                                              }else{
                                                    showDialog<void>(

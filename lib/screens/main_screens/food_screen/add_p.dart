...
class AddFoodScreenP extends StatefulWidget {
  final globalVar goTR;

  const AddFoodScreenP(this.goTR, {super.key});

  @override
  State<AddFoodScreenP> createState() => _AddFoodScreenPState();
}

class _AddFoodScreenPState extends State<AddFoodScreenP> {
                  ...
                  return FutureBuilder(
                      ...
                      builder: (context, snapshotS) {
                        if (snapshotS.hasData) {
                          ...
                          final cal_break = snapshotS.data!.cal_p.toString();
                                            ...
                                            return ElevatedButton(
                                              onPressed: () async {
                                                ...
                                                final foodCal = CalModelP(
                                                  cal_p: (double.parse(cal_break) + double.parse(ui)).toStringAsFixed(1),
                                                );
                                                ...
                                                foodRepo.createFoodRecordP(foodRecord, id.toString());

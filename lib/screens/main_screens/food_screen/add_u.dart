...
class AddFoodScreenU extends StatefulWidget {
  final globalVar goTR;

  const AddFoodScreenU(this.goTR, {super.key});

  @override
  State<AddFoodScreenU> createState() => _AddFoodScreenUState();
}

class _AddFoodScreenUState extends State<AddFoodScreenU> {
                  ...
                  return FutureBuilder(
                      ...
                      builder: (context, snapshotS) {
                        if (snapshotS.hasData) {
                          ...
                          final cal_break = snapshotS.data!.cal_u.toString();
                                            ...
                                            return ElevatedButton(
                                              onPressed: () async {
                                                ...
                                                final foodCal = CalModelU(
                                                  cal_u: (double.parse(cal_break) + double.parse(ui)).toStringAsFixed(1),
                                                );
                                                ...
                                                foodRepo.createFoodRecordU(foodRecord, id.toString());
                                                await controllerFoodB.updateCalU(foodCal, id, id_b.toString());
                                          ...
                                          if(snapshotPFC.hasData){
                                            ...
                                            return ElevatedButton(
                                              onPressed: () {
                                                ...
                                                final foodRepo = Get.put(FoodRepository());
                                                foodRepo.createFoodRecordU(foodRecord, id.toString());
                                                foodRepo.createFoodCalU(foodCal, id.toString());
                                                foodRepo.updatePFC(foodPCF, id.toString(), id_PFC.toString());
                                                widget.goTR.goToRoute(AllRoutes.food);
                                              }else{
                                                    showDialog<void>(
